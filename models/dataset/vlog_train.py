...
class VlogSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        for i in range(self.videoLen):
            ...
            if crop_offset_x == -1:
                # Sample crop offset once for all videoLen frames.
        ...
        # Heuristics to pick "interesting" patches.
        ...
        patch_target = self.geometricTnf(image_batch=imgs_target,
